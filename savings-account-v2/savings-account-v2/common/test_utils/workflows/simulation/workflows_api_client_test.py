from common.test_utils.workflows.simulation.workflows_api_test_base import (
...
class WorkflowSimulatorTest(WorkflowsApiTestBase):
    def test_dummy_workflow(self):
        ...
        first_simulation_response = self.simulate_workflow(
            specification=self.build_test_workflow_specification_loan_approval(
                customer_id
            ),
    ...
    def test_transform_state(self):
        ...
        self.assertEqual(
            next_side_effect_event["context"], {"customer_id": customer_id}
        )
    ...
    def test_steps_action(self):
        ...
        simulation_events = [
            {"name": "A_to_B_1", "context": {"customer_id": customer_id}}
        ]
    ...
    def test_simulate_workflow_instance_pre_schema_3_0_0_expect_success(self):
        ...
        response = self.simulate_workflow(
            specification=self.build_basic_workflow_specification(
